      ...
      body(cls := ExamplesOverviewPageStyles.bodyStyle.name)(
        div(
          ...
          styledSection(
            ...
            a(href := AppPaths.peopleFormPage)(img(src := AppImages.peopleFormGif, alt := "People form animation")),
          ...
          styledSection(
            ...
            a(href := AppPaths.drawPage)(img(src := AppImages.drawOnCanvasGif, alt := "Drawing on canvas animation")),
            p("An HTML5 canvas that you can draw on with the mouse.")
          ),
          styledSection(
            h3(a(href := AppPaths.uploadFilePage)("Upload a file")),
            a(href := AppPaths.uploadFilePage)(img(src := AppImages.uploadFileGif, alt := "File upload animation")),
          ...
          styledSection(
            ...
            a(href := AppPaths.chunkStream)(img(src := AppImages.chunkStreamGif, alt := "Stream data from server animation")),
